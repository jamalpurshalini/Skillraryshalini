...
/**
 * This class contains all reusable methods to perform to perform driver related
 * operations
 * 
 * @author shalini
 */
public class WebDriverUtility {
	...
	/**
	 * This method waits until element is on the web page is enabled to receive
	 * click * @param element
	 * 
	 * @param time
	 * @return
	 ...
	 * @param target
	 */
	public void dranAndDropAnElement(WebElement element, WebElement target) {
		Actions action = new Actions(driver);
	...
	/**
	 * This method is used to switch to frame based on specified element
	 * @author shalini
	 * @param element
	 */
	...
	/**
	 * This method is used to handle to alert pop up
	 * 
	 * @param status
	 */
	...
	/**
	 * This method is used to switch to child browser pop up
	 */
	 ...
	 * @return
	 */
	public WebElement convertPathToWebElemnt(String path, String replaceData) {
